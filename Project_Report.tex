...
\definecolor{darknavyblue}{RGB}{0,0,100}
\definecolor{darkernavyblue}{RGB}{0,0,80}
\definecolor{darkestnavyblue}{RGB}{0,0,60}
...
% Section formatting (subheading level 1)
\titleformat{\section}
{\normalfont\Large\bfseries\color{darknavyblue}}{\thesection}{1em}{}

% Subsection formatting (subheading level 2)
\titleformat{\subsection}
{\normalfont\large\bfseries\color{darkernavyblue}}{\thesubsection}{1em}{}

% Subsubsection formatting (subheading level 3)
\titleformat{\subsubsection}
{\normalfont\normalsize\bfseries\color{darkestnavyblue}}{\thesubsubsection}{1em}{}

% List of Figures spacing (match List of Tables)
\renewcommand{\cftfigafterpnum}{\vskip0.3cm}
...
\begin{titlepage}
    ...
    {\Huge\bfseries Fundamentals of Software Project Management}\\[0.3cm]
...
\begin{itemize}
    ...
    \item \textbf{The Deep Path:} Utilization of Google Gemini 2.5 Flash for high-risk scenarios requiring semantic understanding and empathy.
\end{itemize}
...
\textbf{Resolution:} Developed a utility script (check\_models.py) to dynamically query available models, switching to the stable gemini-2.5-flash.
